...
export const updateProfilePic = TryCatch(
  async (req: AuthenticatedRequest, res) => {
    ...
    const exactUrl =
      imageFile.path || (imageFile as any).secure_url || (imageFile as any).url;
    const exactId = imageFile.filename || (imageFile as any).public_id;
    ...
    await publishToQueue("profile-updates", {
      userId: user._id,
